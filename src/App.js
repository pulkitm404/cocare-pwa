...
function App() {
  ...
  useEffect(() =>{
    ...
    axios.get(url2,  { 'headers': { "secret-key": skey2 } }).then(res => setDailydata(res.data));
  },[]);
  ...
  return (
    ...
    <div className="App">
      ...
      >
        ...
        <PickRegion data={data} handleRegionChange={handleRegionChange}/>
          {data.map((item, index)=>{
